...
//echo 'This is '. isset($address).@$_POST['address'];
// $find = $_POST['find'];
...
<body>
    ...
    $outputString = $date . "\t" . $tireqty . ' tires \\t' . $oilqty . " oil\t"
        ...
        . "\t" . $address . "\n";
    // to do a new line (at least in Windows), it is required to use the \ between "" (double quotes), don't work between '' (single quotes)
    ...
    fclose($fp);
    if ($fp) {
        echo 'Succesfully closed document handler';
    }
